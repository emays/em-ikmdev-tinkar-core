...
public enum LogicalAxiomSemantic {
    ...
    DATA_PROPERTY_SET(TinkarTerm.DATA_PROPERTY_SET, LogicalAxiom.Atom.LogicalSet.TemporalPropertySet.class),
    TEMPORAL_PROPERTY_SET(TinkarTerm.TEMPORAL_PROPERTY_SET, LogicalAxiom.Atom.LogicalSet.DataPropertySet.class),
